"""
HydroSovereign AI Engine (HSAE) v6.1.0
========================================
...
from .legal  import (get_triggered_articles, check_art7_nsh,
    check_art20_envflow, check_art33_dispute, get_legal_assessment)
