...
Open an issue at https://github.com/saifeldinkhedir-coder/HydroSovereign-AI-Engine-HSAE-v601/issues with:
...
3. Add or update tests where applicable and verify no syntax errors:
   ```bash
...
1. Add entry to `basins_global.py` `GLOBAL_BASINS` list (or `GLOFAS_BASINS` for GloFAS-only)
